...
public class MatchingCommunityTest {
	...
	static public <XType extends Comparable<XType>> DistributionStatistics run(Table<Long, XType> attributes, Table<Long, Long> edges) {
		...
		System.out.println("Executing org.dama.datasynth.runtime.spark.operators.matching algorithm");
//		Matching org.dama.datasynth.runtime.spark.operators.matching = new GreedyMatching();
